 ...
 */
const getUnknownSecretObj = (secretObj) => __awaiter(void 0, void 0, void 0, function* () {
    const unknownSecret = {};
    for (let i = 0; i < secretObj.envNameArr.length; i++) {
        const propertyName = secretObj.envNameArr[i];
        unknownSecret[propertyName] = process.env[propertyName];
    }
    return unknownSecret;
});
exports.default = getUnknownSecretObj;
